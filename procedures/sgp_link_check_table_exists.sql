...
BEGIN
    ...
    SET @server = dbo.sgf_format_full_name(@name, '@server')
    
    DECLARE @catalog sysname
    SET @catalog = dbo.sgf_format_full_name(@name, '@catalog')
    
    DECLARE @schema sysname
    SET @schema = dbo.sgf_format_full_name(@name, '@schema')
    
    DECLARE @table sysname
    SET @table = dbo.sgf_format_full_name(@name, '@table')
